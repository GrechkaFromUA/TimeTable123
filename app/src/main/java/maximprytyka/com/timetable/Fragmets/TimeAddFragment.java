        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (add == true) {
                    ...
                    for (int i = 0; i < 10; i++) {
                        String temp = "0" + i;
                        if (String.valueOf(tp1.getCurrentMinute()).equals(String.valueOf(i))) {
                            tt1 = temp;
                            break;
                    ...
                    for (int i = 0; i < 10; i++) {
                        String temp = "0" + i;
                        if (String.valueOf(tp2.getCurrentMinute()).equals(String.valueOf(i))) {
                            tt2 = temp;
                            break;
                    ...
                    for (int i = 0; i < 10; i++) {
                        ...
                        if (String.valueOf(tp1.getCurrentHour()).equals(String.valueOf(i))) {
                            th1 = temp;
                            break;
                    ...
                    for (int i = 0; i < 10; i++) {
                        String temp = "0" + i;
                        if (String.valueOf(tp2.getCurrentHour()).equals(String.valueOf(i))) {
                            th2 = temp;
                            break;
                    ...
                    if (!values.contains(time)) {
                        ...
                        Toast.makeText(getActivity(), R.string.error_same_value, Toast.LENGTH_SHORT).show();
                    }
